    ...
    <div className="d-flex flex-column justify-content-center">
     <Card  className="d-flex align-items-center shadow-lg mb-3 m-3 bg-light border-0"> 
      ...
      <Card.Body>
        ...
        <Card.Text className='bg-white m-2 mb-3 p-4' style={{ lineHeight: 'calc(20px + 0.5625vw)', fontSize:"calc(14px + 0.300625vw)", maxHeight:"calc(150px + 30vh", maxWidth:"900px", overflowY:"auto", textAlign:"justify"}}>
